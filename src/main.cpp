...
int main() {
  ...
  // std::cout << "list.insert_many: " << l.front() << ' ' << l.back() << std::endl;
  // l.print_list();
  // l.insert_many_back(1, 2, 3);
  // std::cout << "list.insert_many_back: " << l.front() << ' ' << l.back() << std::endl;
  // l.print_list();
  // l.insert_many_front(1, 2, 3);
  // std::cout << "list.insert_many_front: " << l.front() << ' ' << l.back() << std::endl;
  // l.print_list();
  l.pop_back();
